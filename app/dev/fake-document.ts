...
export const mockSuccessDocument: VerificationDocument = {
  ...
  hpkePublicKey:
    "04a8b5c6d7e8f9a0b1c2d3e4f5a6b7c8d9e0f1a2b3c4d5e6f7a8b9c0d1e2f3a4b5",
  codeFingerprint:
    "sha256:74e1b91b4867d4b0fc3a1e9bc82a999aa1dd96c7fa968eefc8c9a7bd403f2f00",
  enclaveFingerprint:
...
export const mockCertificateFailureDocument: VerificationDocument = {
  configRepo: "tinfoilsh/example-configs",
  enclaveHost: "https://demo.enclave.tinfoil.sh",
  releaseDigest:
    "sha256:74e1b91b4867d4b0fc3a1e9bc82a999aa1dd96c7fa968eefc8c9a7bd403f2f00",
  ...
  steps: {
    ...
    verifyCertificate: {
      status: "failed",
      error:
        "Certificate verification failed: HPKE key in certificate SAN does not match attested key.",
    },
  },
};

export const mockCertificateHashFailureDocument: VerificationDocument = {
  configRepo: "tinfoilsh/example-configs",
  enclaveHost: "https://demo.enclave.tinfoil.sh",
  releaseDigest:
    "sha256:74e1b91b4867d4b0fc3a1e9bc82a999aa1dd96c7fa968eefc8c9a7bd403f2f00",
  ...
  steps: {
    ...
    verifyCertificate: {
      status: "failed",
      error:
        "Certificate verification failed: Attestation hash in certificate SAN does not match document hash.",
    },
  },
};
...
export const mockOtherErrorDocument: VerificationDocument = {
  ...
  steps: {
    ...
    otherError: {
      status: "failed",
      error:
        "An unexpected error occurred during verification: Network connection lost.",
    },
  },
};
...
export const mockEnclaveFailureDocument: VerificationDocument = {
  ...
  steps: {
    ...
    verifyEnclave: {
      status: "failed",
      error:
        "Enclave attestation signature verification failed. Invalid certificate chain.",
    },
